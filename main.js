...
if(car1_x > car2_x){
    ...
    console.log("Car 1 Is winning");
    document.getElementById("game_status").innerHTML = "Car 1 Is Winning";
}

if(car1_x < car2_x){

    console.log("Car 2 Is winning");
    document.getElementById("game_status").innerHTML = "Car 2 Is Winning";
}
